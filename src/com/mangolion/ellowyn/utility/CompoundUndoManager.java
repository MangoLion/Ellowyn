...
public class CompoundUndoManager extends UndoManager {
     ...
     */
    public static final int IDLE_DELAY_MS = 500, IDLE_CLEAR_MS = 50000;

    long startMillis = 0, lifeMillis = 0;
    ...
    public synchronized boolean addEdit(UndoableEdit anEdit) {
        ...
        //System.out.println("added "+ anEdit.getPresentationName());
        comp.addEdit(anEdit);
        ...
        if (lifeMillis == 0)
        	lifeMillis = now;
        if (now - lifeMillis > IDLE_CLEAR_MS){
        	lifeMillis = now;
        	discardAllEdits();
        }
